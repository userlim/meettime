...
export default function PrivacyPolicy() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold mb-3 text-gray-800">Cookies</h2>
        <p className="text-gray-700 leading-relaxed">
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold mb-3 text-gray-800">Google AdSense</h2>
        <p className="text-gray-700 leading-relaxed">
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold mb-3 text-gray-800">Google Analytics</h2>
        <p className="text-gray-700 leading-relaxed">
