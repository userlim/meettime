  ...
  return (
    <html lang="en">
      ...
      <body className="antialiased">
        <header className="border-b border-[#F2F4F6] bg-white sticky top-0 z-50">
          <div className="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between">
            ...
            <a href="/" className="text-sm text-[#4E5968] hover:text-indigo-600 transition">New Event</a>
          </div>
        </header>
        <main className="flex-1">
          {children}
        </main>
        <footer className="border-t border-[#F2F4F6] bg-white py-6 text-center text-sm text-[#8B95A1]">
