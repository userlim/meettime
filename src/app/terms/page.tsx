...
export default function Terms() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold mb-3 text-gray-800">Use of Service</h2>
        <p className="text-gray-700 leading-relaxed">
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold mb-3 text-gray-800">Data and Privacy</h2>
        <p className="text-gray-700 leading-relaxed">
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold mb-3 text-gray-800">Advertisements</h2>
        <p className="text-gray-700 leading-relaxed">
